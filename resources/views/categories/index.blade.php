...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">{{ translate('Categories') }}</div>
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('categories.create', ['lang' => app()->getLocale()]) }}" class="btn btn-primary">{{ translate('Create Category') }}</a>
                </div>
            </div>
        </div>
        <div class="card">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex order-actions">
                                            <a href="{{ route('categories.edit', ['lang' => app()->getLocale(), 'category' => $category->id]) }}" class=""><i class='bx bxs-edit'></i></a>
