                            ...
                            <div class="entry-img">
                                <div class="entry-date">
                                    <div class="entry-content"><span
                                            ...
                                            class="month">{{ $item->created_at->format('M') }}</span><span
                                            class="year">{{ $item->created_at->format('Y') }}</span></div>
                                </div>
                                <!-- End .entry-date-->
                                <a
                                    href="{{ route('frontpage.news.show', [
                                        ...
                                        alt="{{ $item->getTranslation('name', app()->getLocale()) }}" /></a>
                            </div>
                            <!-- End .entry-img-->
                                ...
                                <div class="entry-meta">
                                    <div class="entry-category"><a
                                            href="{{ route('frontpage.news.show', [
                                                ...
                                                src="{{ asset('storage/' . $item->image) }}">{{ $category->getTranslation('name', app()->getLocale()) }}</a>
                                    </div>
