    ...
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">{{ translate('Edit') }} {{ translate('About') }}</h5>
            </div>
        </div>
            ...
            <div class="card-body">
                <form action="{{ route('abouts.update', ['lang' => app()->getLocale(), 'about' => $about->id]) }}" method="POST">
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" 
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" 
                                           ...
                                           class="form-control"
                                           value="{{ $about->getTranslation('title', $language->code, false) }}"
                                           required>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label">
                                    ...
                                    <textarea class="editor"
                                              ...
                                              required>{{ $about->getTranslation('content', $language->code, false) }}</textarea>
                                </div>
                            </div>
                        @endforeach
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" type="date" name="date_published" value="{{ $about->date_published }}">
                    </div>
                    <div class="mb-3">
                        <label class="form-label">
                            End Date
                        </label>
                        <input class="form-control" type="date" name="end_date" value="{{ $about->end_date }}">
                    </div>

                    <div class="mb-3">
                        <label for="is_published" class="form-label">{{ translate('Show in Footer') }}</label>
                    ...
                    <button type="submit" class="btn btn-primary">
                        {{ translate('Update') }} {{ translate('About') }}
                    </button>
                </form>
            </div>
        </div>
