...
<div class="page-wrapper">
   <div class="page-content">
       ...
       <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
           <div class="breadcrumb-title pe-3">{{ translate('Edit') }} {{ translate('Page') }}</div>
       </div>
       <!--end breadcrumb-->
       <div class="card">
           <div class="card-body">
                       ...
                       <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-{{ $language->code }}"
                           ...
                           <div class="mb-3">
                               ...
                               <input class="form-control" type="text" name="translations[{{ $language->code }}][title]"
                                   ...
                                   value="{{ $page->title[$language->code] ?? '' }}"
                           ...
                           <div class="mb-3">
                               ...
                               <textarea class="editor" name="translations[{{ $language->code }}][content]"
                                   ...
                                   placeholder="{{ translate('Enter content') }} {{ $language->name }}" required>
