...
<div class="nxl-content">
    <div class="page-header">
        <div class="page-header-left d-flex align-items-center">
            <div class="page-header-title">
                <h5 class="m-b-10">{{ translate('Edit') }} {{ translate('Page') }}</h5>
            </div>
        </div>
    ...
    <div class="main-content">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('pages.update', ['page' => $page->id, 'lang' => app()->getLocale()]) }}" method="POST">
                    @csrf
                    @method('PUT')
                            ...
                            <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" id="lang-{{ $language->code }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" name="translations[{{ $language->code }}][title]"
                                        id="title_{{ $language->code }}" value="{{ $page->title[$language->code] ?? '' }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="editor" name="translations[{{ $language->code }}][content]"
                                        id="content_{{ $language->code }}" placeholder="{{ translate('Enter content') }} {{ $language->name }}" required>
                    ...
                    <!-- Options for is_header and is_footer -->
                    <div class="mb-3">
                    ...
                    <div class="col-md-12 text-end">
                        <button type="submit" class="btn btn-primary">{{ translate('Update') }} {{ translate('Page') }}</button>
                    </div>
                </form>
            </div>
        </div>
