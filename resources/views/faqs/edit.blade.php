   ...
   <div class="page-header">
       <div class="page-header-left d-flex align-items-center">
           <div class="page-header-title">
               <h5 class="m-b-10">{{ translate('Edit') }} {{ translate('Faq') }}</h5>
           </div>
       </div>
           ...
           <div class="card-body">
               <form action="{{ route('faqs.update', ['lang' => app()->getLocale(), 'faq' => $faq->id]) }}" method="POST">
                           ...
                           <div class="tab-pane fade {{ $loop->first ? 'show active' : '' }}" 
                               ...
                               <div class="mb-3">
                                   ...
                                   <input type="text" 
                                          ...
                                          class="form-control"
                                          value="{{ $faq->getTranslation('title', $language->code, false) }}"
                                          required>
                               </div>
                               <div class="mb-3">
                                   <label class="form-label">
                                   ...
                                   <textarea class="editor"
                                             ...
                                             required>{{ $faq->getTranslation('content', $language->code, false) }}</textarea>
                               </div>
                           </div>
                       @endforeach
                   </div>
                   ...
                   <button type="submit" class="btn btn-primary">
                       {{ translate('Update') }} {{ translate('Faq') }}
                   </button>
               </form>
           </div>
       </div>
