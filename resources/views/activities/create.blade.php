...
<div class="page-wrapper">
   <div class="page-content">
       ...
       <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
           <div class="breadcrumb-title pe-3">{{ translate('Create') }} {{ translate('Activity') }}</div>
       </div>
       <!--end breadcrumb-->
       <div class="card">
           <div class="card-body">
               <form action="{{ route('activities.store', ['lang' => app()->getLocale()]) }}" method="POST">
                   @csrf
                   ...
                   <!-- Submit Button -->
                   <div class="col-md-12">
                       <button type="submit" class="btn btn-primary">{{ translate('Create') }} {{ translate('Activity') }}</button>
                   </div>
               </form>
           </div>
       </div>
