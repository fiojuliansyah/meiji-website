...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">{{ translate('Create Category') }}</div>
        </div>
        <div class="card">
            <div class="card-body">
                <form action="{{ route('news_categories.store', ['lang' => app()->getLocale()]) }}" method="POST">
                    @csrf
                    ...
                    <div class="col-12">
                        <button type="submit" class="btn btn-primary">{{ translate('Create Category') }}</button>
                    </div>
                </form>
            </div>
        </div>
