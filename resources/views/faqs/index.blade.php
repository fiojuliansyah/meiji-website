...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">{{ translate('Faqs') }}</div>
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('faqs.create', ['lang' => app()->getLocale()]) }}" class="btn btn-primary">{{ translate('Create About') }}</a>
                </div>
            </div>
        </div>
        <div class="card">
                        ...
                        <tbody>
                            @foreach ($faqs as $faq)   
                                <tr>
                                    ...
                                    {{-- <td>{!! $faq->getTranslation('content', app()->getLocale()) !!}</td> --}}
                                    <td>
