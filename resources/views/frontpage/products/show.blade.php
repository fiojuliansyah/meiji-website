...
@push('css')
  <style>
    /* Kelas untuk efek blur pada background */
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
      ...
      // Tambahkan blur pada background
      ...
      document.getElementById('agreeButton').addEventListener('click', function() {
          ...
          document.body.classList.remove('modal-blur-background'); // Hapus blur saat setuju
      });

      // Ketika modal ditutup, hapus blur
      disclaimerModal._element.addEventListener('hidden.bs.modal', function () {
          document.body.classList.remove('modal-blur-background');
      });
  });
</script>
